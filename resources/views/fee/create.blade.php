    ...
    <div class="col-12">
      <div class="breadcrumb-section">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
          <a href="{{route('fee.create')}}">Create Fee</a>
          </li>
        </ol>
      </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input value="{{ old('name') }}" name="name" required type="text" class="form-control" placeholder="Enter fee name">
                        @error('name')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input value="{{ old('price') }}" name="price" required type="number" class="form-control" placeholder="Enter fee price">
                        @error('price')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
