...
$(document).ready(function(){
  ...
  heroSlider.owlCarousel({   
       ...
       $(".owl-item.active .carsl_btn").addClass('animated fadeInUp delay-3');
       ...
       $(".hero_carosel").on('change.owl.carousel', function(event) {
        ...
        $('.carsl_btn').removeClass('animated fadeInUp delay-3');
        ...
        $('.owl-item').not('.cloned').eq(item).find('.carsl_btn').addClass('animated fadeInUp delay-3');    
     });


     var TeamSlider = $('.team_carosel');
